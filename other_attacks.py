...
def model_selection(name):
    dic = {
        "R": "../checkpoints/ckpt_ori/resnet50.pth",
        "E": "../checkpoints/ckpt_ori/efficientnet-b0.pth",
        "D": "../checkpoints/ckpt_ori/deit.pth",
        "S": "../checkpoints/ckpt_ori/swin-t.pth",
    }
    # dic = {
    #     "R": "/path/to/.pth",
    #     "E": "/path/to/.pth",
    ...
    if name == "R":
        ...
        model_path = dic[name]
        pretrain_cfg = timm.models.create_model('swin_base_patch4_window7_224').default_cfg
        pretrain_cfg['file'] = 'path/to/swin_base_patch4_window7_224_22kto1k.pth'
        model = timm.create_model('swin_base_patch4_window7_224', pretrained=True, pretrained_cfg=pretrain_cfg)
